...
class Emojifier {
    ...
    private static void whichEmoji(Face face) {
        ...
        final double PERSON_SMILING = 0.15;
        final double RIGHT_EYE_OPEN = 0.5;
        final double LEFT_EYE_OPEN = 0.5;
        ...
        boolean isSmiling = false, isLeftEyeClosed = false, isRightEyeClosed = false;

        if(face.getIsSmilingProbability()>PERSON_SMILING){
            isSmiling =true;
        }
